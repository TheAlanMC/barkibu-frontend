...
class QuestionDetailService {
  static Future<QuestionDto> getQuestion(questionId) async {
  ...
  static Future<QuestionPetInfoDto> getQuestionPetInfo(questionId) async {
    String token = await TokenSecureStorage.readToken();
    String baseUrl = services.baseUrl;
    final header = {
      'Content-Type': 'application/json',
  ...
  static Future<QuestionAnswerDto> getQuestionAnswer(questionId) async {
    String token = await TokenSecureStorage.readToken();
    String baseUrl = services.baseUrl;
    final header = {
      'Content-Type': 'application/json',
    ...
    return QuestionAnswerDto.fromMap(responseDto.result);
  }
}
