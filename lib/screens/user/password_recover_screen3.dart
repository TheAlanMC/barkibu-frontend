              ...
              SliverFillRemaining(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomMaterialButton(
                        text: 'Guardar',
                        onPressed: () => passwordManagementCubit.updatePassword(
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            onChanged: (value) => BlocProvider.of<PasswordManagementCubit>(context).passwordStrength(_passwordController.text),
